...
class iconRPC:
    ...
    def __init__(self, rpc_url: str):
        ...
        # self._counter_unexpected_status = Counter('icon_exporter_rpc_unexpected_status','############################RPC call unexpected HTTP status errors')
        # self._counter_request_error = Counter('icon_exporter_rpc_error', '###################################RPC calls declined by icon node')
